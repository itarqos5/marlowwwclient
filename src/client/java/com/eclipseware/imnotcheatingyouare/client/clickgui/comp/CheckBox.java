...
public class CheckBox extends Comp {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        // Draw Setting Name
        guiGraphics.drawString(Minecraft.getInstance().font, setting.getName(), (int)(parent.posX + x + 30), (int)(parent.posY + y + 2), new Color(200, 200, 200).getRGB(), false);
    }

    @Override
    public void mouseClicked(double mouseX, double mouseY, int mouseButton) {
        if (isInside(mouseX, mouseY, parent.posX + x, parent.posY + y, parent.posX + x + 24 + Minecraft.getInstance().font.width(setting.getName()), parent.posY + y + 12) && mouseButton == 0) {
